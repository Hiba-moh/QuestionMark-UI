...
function Footer () {
  return (
    <nav class="navbar navbar-light  HeaderbackColor">
      <footer className="footer">
        <div className="logo-container">
          <a target="_blank" href="https://www.instagram.com/codeyourfuture_/">
            <img
              className="logo"
              src="https://goldengatexpress.org/wp-content/uploads/2020/05/The_Instagram_Logo.jpg"
            />
          </a>
          ...
          <a target="_blank" href="https://codeyourfuture.io/">
            <img
              className="logo"
              src="https://www.scottishrefugeecouncil.org.uk/wp-content/uploads/2019/10/Code-Your-Future.jpg"
            />
          </a>
        </div>
        <h5>
          CYF | West Midlands | Team QuestionMark 2020 | All rights reserved | Registered charity 1174929 | Send website feedback &reg;
        </h5>
      </footer>
    </nav>
  );
